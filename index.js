        ...
        function earnAd(){
          if(typeof window.show_9755147 === "function"){
            window.show_9755147().then(()=>{
              ...
              document.getElementById("msg").textContent = "⚠️ Iklan gagal dimuat";
            });
          } else {
            // fallback kalau iklan gak tersedia
            setTimeout(()=>{
              updateBalance(5);
              document.getElementById("msg").textContent = "⏳ Fake ad selesai, +5 PIR";
            }, 5000);
          }
        }
